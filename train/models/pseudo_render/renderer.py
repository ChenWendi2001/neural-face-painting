    ...
    def __init__(self, renderer='oilpaintbrush', CANVAS_WIDTH=128, train=False, canvas_color='black'):
        ...
        if self.renderer in ['markerpen']:
            ...
            self.brush_small_vertical = cv2.imread(
                os.path.join(os.getcwd(),"models", "pseudo_render", 'brushes/brush_fromweb2_small_vertical.png'), cv2.IMREAD_GRAYSCALE)
            self.brush_small_horizontal = cv2.imread(
                os.path.join(os.getcwd(),"models", "pseudo_render", 'brushes/brush_fromweb2_small_horizontal.png'), cv2.IMREAD_GRAYSCALE)
            self.brush_large_vertical = cv2.imread(
                os.path.join(os.getcwd(),"models", "pseudo_render", 'brushes/brush_fromweb2_large_vertical.png'), cv2.IMREAD_GRAYSCALE)
            self.brush_large_horizontal = cv2.imread(
                os.path.join(os.getcwd(),"models", "pseudo_render", 'brushes/brush_fromweb2_large_horizontal.png'), cv2.IMREAD_GRAYSCALE)
